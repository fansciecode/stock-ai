...
class SubscriptionManager:
    ...
    def check_subscription_status(self, user_id: str) -> Dict:
        """Check detailed subscription status for dashboard display"""
        try:
            ...
            # Get trading access info
            access_info = self.check_trading_access(user_id)
            ...
            return {
                ...
                'subscription': {
                    ...
                    'trading_enabled': access_info.get('has_access', False),
                    'access_reason': access_info.get('reason', 'Unknown'),
                    'is_lifetime': sub_data['tier'] == 'LIFETIME',
                    'is_active': sub_data['status'] == 'ACTIVE'
                }
            }
        except Exception as e:
            return {
